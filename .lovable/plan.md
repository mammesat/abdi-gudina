...
## Phase 5 — Accessibility & Responsive Pass
...
## Phase 6 — SEO, Performance & CMS Handoff
...
1. **Approve the phased approach** (vs. one giant PR).
2. **Say "start Phase 1"** and I'll ship the design system foundation this turn — that alone is a substantial change (~15–20 files, all additive/refactor, no visible regressions).
3. Optional: if any phase priority is wrong (e.g. "do Resources template before homepage"), tell me now and I'll reorder.
